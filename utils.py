...
def create_servers_list(data: pd.DataFrame, config_dict: dict)-> Tuple[pd.DataFrame]:
    ...
    cpu_undersized = data[cpu_undersized_mask]
    ...
    cpu_oversized = data[cpu_oversized_mask]
    ...
    ram_undersized = data[ram_undersized_mask]
    ...
    ram_oversized = data[ram_oversized_mask]
